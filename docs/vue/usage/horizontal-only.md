...
To place the horizontal scrollbar in a custom position (e.g. above the content), use the standalone [HorizontalScrollBar](/vue/usage/using-horizontal-scroll-bar) component instead.
